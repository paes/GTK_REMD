chmod 777 *.x *.sh
./get_from_tra.x 1e0l.pdb 0
python remove_heatoms.py 1e0l.pdb_0
pdb4amber -i 1e0l.pdb_0 -o 1E0L_P.pdb —ypd
cp 1E0L_P.pdb ../LEAP/1E0L_Pfirst.pdb
tleap -f ../LEAP/leap.in # depois de configurar o leap
cp job_id.prmtop ../LEAP
cp job_id.inpcrd ../LEAP
cp 1e0l.pdb ../LEAP
cp 1E0L_Pfirst.pdb ../LEAP
cp leap.log ../LEAP
