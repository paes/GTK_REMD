...
nrep=`wc temperatures.dat | awk '{print $2}'` #where /home/lipinski/Dropbox/gtk_remd/2HBA_B_F1/temperatures.dat is the temperature.dat complete path
for T in `cat temperatures.dat` ; do
		...
		trajout remd_001_small_001.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_002.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_003.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_004.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_005.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_006.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_007.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_008.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_009.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_010.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_011.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_012.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_013.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_014.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_015.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_016.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_017.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_018.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_019.Ttraj.$T ncdf
		go
EOF
		...
		trajout remd_001_small_020.Ttraj.$T ncdf
		go
EOF
