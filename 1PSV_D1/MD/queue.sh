chmod 777 *.x *.sh
./get_from_tra.x 1psv.pdb 0
python remove_heatoms.py 1psv.pdb_0
pdb4amber -i 1psv.pdb_0 -o 1PSV_P.pdb —ypd
cp 1PSV_P.pdb ../LEAP/1PSV_Pfirst.pdb
tleap -f ../LEAP/leap.in # depois de configurar o leap
cp job_id.prmtop ../LEAP
cp job_id.inpcrd ../LEAP
cp 1psv.pdb ../LEAP
cp 1PSV_Pfirst.pdb ../LEAP
cp leap.log ../LEAP
