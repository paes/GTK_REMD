...
nrep=`wc temperatures.dat | awk '{print $2}'` #where /home/lipinski/Dropbox/gtk_remd/1RIJ_D1/temperatures.dat is the temperature.dat complete path
...
EOF
	...
	clusco_cpu -t remd_total_Ttraj.$ext.pdb -s gdt -e ../LEAP/1RIJ_Pfirst.pdb  -o gdt-total_Ttraj.$ext.dat
