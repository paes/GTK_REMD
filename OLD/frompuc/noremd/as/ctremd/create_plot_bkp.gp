...
#The main idea is to create a plot with maximum, minimum and average RMSD/GDT, we'll need 4 input files, dados.dat dados2.dat dados3.dat e dados4.dat contendo cada um X linhas onde X é o numero de replicas: TEMP, AVG, MIN, MAX
...
# t "Test 1" = title "Test 1" will go in thFRMSDe legend
