...
mkdir $TRUE/R1R2R3_ct_1ns_vs_ct_2ns #crio uma pasta antes da pasta da simulacao (onde as outras simulacoes tb estao)
cp ../../../../group_energies.py $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/group_energies.py
cp ../../temperatures.dat $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/temperatures.dat
...
do
    ...
    tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/dist_${TEMP}_4.dat #>  ../../../../../R1R2R3_ct_1ns_vs_ct_2ns/dist_$TEMP_1.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
    tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/dist_${TEMP}_5.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
      tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/dist_${TEMP}_6.dat 
done

cp temperatures-no50.dat $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/temperatures-no50.dat
...
mkdir $TRUE/R1R2R3_ct_1ns_vs_ct_2ns #crio uma pasta antes da pasta da simulacao (onde as outras simulacoes tb estao)
cp $TRUE/group_energies.py $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/group_energies.py
cp ../../temperatures.dat $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/temperatures.dat
...
do
	#echo " $TEMP"
    #echo "dist-energy_$TEMP.xvg"
    tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/dist_remd_${TEMP}_4.dat #>  ../../../../../R1R2R3_ct_1ns_vs_ct_2ns/dist_$TEMP_1.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
    tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/dist_remd_${TEMP}_5.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
      tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/dist_remd_${TEMP}_6.dat 
done
...
cd $TRUE/R1R2R3_ct_1ns_vs_ct_2ns/
