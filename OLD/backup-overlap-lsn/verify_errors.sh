...
set output "./errors_ln_$1_win$2.${output_extension}"
...
plot 'output_erro_r1ln_$1_win$2.dat'  using (\$1*4 + 0.26):(\$2) with boxes ls 1  title "CTREMD"  ,\
	 'output_erro_r1ln_$1_win$2.dat' using  (\$1*4 - 0.26):(\$4) with boxes ls 2 title "REMD"
