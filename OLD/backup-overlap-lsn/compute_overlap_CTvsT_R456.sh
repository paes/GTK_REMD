...
mkdir ../../../../../R4R5R6_ct_vs_t #crio uma pasta antes da pasta da simulacao (onde as outras simulacoes tb estao)
cp ../../../../group_energies.py ../../../../../R4R5R6_ct_vs_t/group_energies.py
cp ../../temperatures.dat ../../../../../R4R5R6_ct_vs_t/temperatures.dat
...
do
    ...
    tail -n +13 "dist-energy_$TEMP.xvg" > ../../../../../R4R5R6_ct_vs_t/dist_${TEMP}_4.dat #>  ../../../../../R4R5R6_ct_vs_t/dist_$TEMP_1.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
    tail -n +13 "dist-energy_$TEMP.xvg" > ../../../../../R4R5R6_ct_vs_t/dist_${TEMP}_5.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
      tail -n +13 "dist-energy_$TEMP.xvg" > ../../../../../R4R5R6_ct_vs_t/dist_${TEMP}_6.dat 
done

cp temperatures-no50.dat ../../../../../R4R5R6_ct_vs_t/temperatures-no50.dat
...
do
	#echo " $TEMP"
    #echo "dist-energy_$TEMP.xvg"
    tail -n +13 "dist-energy_$TEMP.xvg" > ../../../../../R4R5R6_ct_vs_t/dist_remd_${TEMP}_4.dat #>  ../../../../../R4R5R6_ct_vs_t/dist_$TEMP_1.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
    tail -n +13 "dist-energy_$TEMP.xvg" > ../../../../../R4R5R6_ct_vs_t/dist_remd_${TEMP}_5.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
      tail -n +13 "dist-energy_$TEMP.xvg" > ../../../../../R4R5R6_ct_vs_t/dist_remd_${TEMP}_6.dat 
done
