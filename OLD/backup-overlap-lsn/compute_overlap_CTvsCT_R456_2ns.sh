...
mkdir $TRUE/R4R5R6_ct_1ns_vs_ct_2ns #crio uma pasta antes da pasta da simulacao (onde as outras simulacoes tb estao)
cp ../../../../group_energies.py $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/group_energies.py
cp ../../temperatures.dat $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/temperatures.dat
...
do
    ...
    tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/dist_${TEMP}_4.dat #>  ../../../../../R4R5R6_ct_1ns_vs_ct_2ns/dist_$TEMP_1.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
    tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/dist_${TEMP}_5.dat 
done
...
cat temperatures-no50.dat | while read TEMP
do
      tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/dist_${TEMP}_6.dat 
done

cp temperatures-no50.dat $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/temperatures-no50.dat
...
#cd $1_RUN4/MD/EnergyDistribution/output #isso morre depois do teste
#cd ../../../../../02-REMD/
#cd $3_RUN4/MD/EnergyDistribution/
cd /media/lipinski/bbd7c4d4-68cf-4c17-a487-ee8d7c3a4657/home/tpaes/PLANNED/PLANNED_SIMULATIONS/1UNC/2ns/01-CTREMD/1UNC_2ns_1_RUN4/MD/EnergyDistribution/
...
mkdir $TRUE/R4R5R6_ct_1ns_vs_ct_2ns #crio uma pasta antes da pasta da simulacao (onde as outras simulacoes tb estao)
cp $TRUE/group_energies.py $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/group_energies.py
cp ../../temperatures.dat $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/temperatures.dat
...
do
	#echo " $TEMP"
    #echo "dist-energy_$TEMP.xvg"
    tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/dist_remd_${TEMP}_4.dat #>  ../../../../../R4R5R6_ct_1ns_vs_ct_2ns/dist_$TEMP_1.dat 
done
...
cp temperatures-no50.dat /media/lipinski/bbd7c4d4-68cf-4c17-a487-ee8d7c3a4657/home/tpaes/PLANNED/PLANNED_SIMULATIONS/1UNC/2ns/01-CTREMD/1UNC_2ns_1_RUN5/MD/EnergyDistribution/output/temperatures-no50.dat

cd /media/lipinski/bbd7c4d4-68cf-4c17-a487-ee8d7c3a4657/home/tpaes/PLANNED/PLANNED_SIMULATIONS/1UNC/2ns/01-CTREMD/1UNC_2ns_1_RUN5/MD/EnergyDistribution/
...
cat temperatures-no50.dat | while read TEMP
do
    tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/dist_remd_${TEMP}_5.dat 
done

cp temperatures-no50.dat /media/lipinski/bbd7c4d4-68cf-4c17-a487-ee8d7c3a4657/home/tpaes/PLANNED/PLANNED_SIMULATIONS/1UNC/2ns/01-CTREMD/1UNC_2ns_1_RUN6/MD/EnergyDistribution/output/temperatures-no50.dat
...
cat temperatures-no50.dat | while read TEMP
do
      tail -n +13 "dist-energy_$TEMP.xvg" > $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/dist_remd_${TEMP}_6.dat 
done
...
cd $TRUE/R4R5R6_ct_1ns_vs_ct_2ns/
