...
nrep=`wc temperatures.dat | awk '{print $2}'` #where /home/lipinski/Dropbox/gtk_remd/1FME_1ns_4_R1/temperatures.dat is the temperature.dat complete path
count=0
...
do                                
  ...
  echo "mpirun -np 12 -machinefile machinefile $AMBERHOME/bin/pmemd.MPI -O -l remd_001_small_001.log.$REP -i remd_001_small_001.mdin.$REP -c mini_000.rst -r remd_001_small_001.rst.$REP -x remd_001_small_001.ncdf.$REP -inf remd_001_small_001.mdinfo.$REP -p ../LEAP/$1.prmtop -o remd_001_small_001.mdout.$REP " >> run_$REP.sh
  rm -f temp temp2
  ...
  echo "mpirun -np 12 -machinefile machinefile $AMBERHOME/bin/pmemd.MPI -O -l remd_002.log.$REP -i remd_002.mdin.$REP -c remd_001_small_020.rst.$REP -r remd_002.rst.$REP -x remd_002.ncdf.$REP -inf remd_002.mdinfo.$REP -p ../LEAP/$1.prmtop -o remd_002.mdout.$REP" >> run_$REP.sh
  rm -f temp temp2
  ...
  echo "mpirun -np 12 -machinefile machinefile $AMBERHOME/bin/pmemd.MPI -O -l remd_003.log.$REP -i remd_003.mdin.$REP -c remd_002.rst.$REP -r remd_003.rst.$REP -x remd_003.ncdf.$REP -inf remd_003.mdinfo.$REP -p ../LEAP/$1.prmtop -o remd_003.mdout.$REP" >> run_$REP.sh
  rm -f temp temp2
  ...
  echo "mpirun -np 12 -machinefile machinefile $AMBERHOME/bin/pmemd.MPI -O -l remd_004.log.$REP -i remd_004.mdin.$REP -c remd_003.rst.$REP -r remd_004.rst.$REP -x remd_004.ncdf.$REP -inf remd_004.mdinfo.$REP -p ../LEAP/$1.prmtop -o remd_004.mdout.$REP" >> run_$REP.sh
  rm -f temp temp2
  ...
  echo "mpirun -np 12 -machinefile machinefile $AMBERHOME/bin/pmemd.MPI -O -l remd_005.log.$REP -i remd_005.mdin.$REP -c remd_004.rst.$REP -r remd_005.rst.$REP -x remd_005.ncdf.$REP -inf remd_005.mdinfo.$REP -p ../LEAP/$1.prmtop -o remd_005.mdout.$REP" >> run_$REP.sh
  rm -f temp temp2
  ...
  echo "mpirun -np 12 -machinefile machinefile $AMBERHOME/bin/pmemd.MPI -O -l remd_006.log.$REP -i remd_006.mdin.$REP -c remd_005.rst.$REP -r remd_006.rst.$REP -x remd_006.ncdf.$REP -inf remd_006.mdinfo.$REP -p ../LEAP/$1.prmtop -o remd_006.mdout.$REP" >> run_$REP.sh
  rm -f temp temp2
