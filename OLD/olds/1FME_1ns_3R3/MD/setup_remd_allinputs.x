...
nrep=`wc temperatures.dat | awk '{print $2}'` #where /media/lipinski/345fad8a-4774-4a42-9ee1-cb2ba5a0d23b/Dropbox/gtk_remd/1FME_1ns_3R3/temperatures.dat is the temperature.dat complete path
count=0
...
do                                
  ...
  echo "mpirun -np 6 -machinefile machinefile $AMBERHOME/bin/pmemd.MPI -O -l remd_001_small_001.log.$REP -i remd_001_small_001.mdin.$REP -c mini_000.rst -r remd_001_small_001.rst.$REP -x remd_001_small_001.ncdf.$REP -inf remd_001_small_001.mdinfo.$REP -p ../LEAP/$1.prmtop -o remd_001_small_001.mdout.$REP " >> run_$REP.sh
  rm -f temp temp2
  ...
  echo "mpirun -np 6 -machinefile machinefile $AMBERHOME/bin/pmemd.MPI -O -l remd_002.log.$REP -i remd_002.mdin.$REP -c remd_001_small_020.rst.$REP -r remd_002.rst.$REP -x remd_002.ncdf.$REP -inf remd_002.mdinfo.$REP -p ../LEAP/$1.prmtop -o remd_002.mdout.$REP" >> run_$REP.sh
  rm -f temp temp2
