chmod 777 *.x *.sh
./get_from_tra.x 1UNC01-Hs.pdb 0
python remove_heatoms.py 1UNC01-Hs.pdb_0
pdb4amber -i 1UNC01-Hs.pdb_0 -o 1UNC_P.pdb —ypd
cp 1UNC_P.pdb ../LEAP/1UNC_Pfirst.pdb
tleap -f ../LEAP/leap.in # depois de configurar o leap
cp job_id.prmtop ../LEAP
cp job_id.inpcrd ../LEAP
cp 1UNC01-Hs.pdb ../LEAP
cp 1UNC_Pfirst.pdb ../LEAP
cp leap.log ../LEAP
...
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_021.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_022.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_023.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_024.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_025.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_026.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_027.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_028.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_029.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_030.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_031.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_032.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_033.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_034.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_035.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_036.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_037.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_038.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_039.groupfile
mpirun -machinefile machinefile -np 70 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_040.groupfile
