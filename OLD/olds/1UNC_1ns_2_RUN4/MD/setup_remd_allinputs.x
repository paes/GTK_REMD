#!/bin/bash -f
rm remd_*.groupfile
nrep=`wc temperatures.dat | awk '{print $2}'` #where /home/lipinski/Dropbox/gtk_remd/1UNC_1ns_2_RUN4//temperatures.dat is the temperature.dat complete path
count=0
...
do                                
  ...
  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_021.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_021.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_021.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_021.log -i remd_001_small_021.mdin.$REP -o remd_001_small_021.mdout.$REP -c remd_001_small_020.rst.$REP -r remd_001_small_021.rst.$REP -x remd_001_small_021.ncdf.$REP -inf remd_001_small_021.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_021.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_022.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_022.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_022.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_022.log -i remd_001_small_022.mdin.$REP -o remd_001_small_022.mdout.$REP -c remd_001_small_021.rst.$REP -r remd_001_small_022.rst.$REP -x remd_001_small_022.ncdf.$REP -inf remd_001_small_022.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_022.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_023.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_023.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_023.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_023.log -i remd_001_small_023.mdin.$REP -o remd_001_small_023.mdout.$REP -c remd_001_small_022.rst.$REP -r remd_001_small_023.rst.$REP -x remd_001_small_023.ncdf.$REP -inf remd_001_small_023.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_023.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_024.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_024.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_024.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_024.log -i remd_001_small_024.mdin.$REP -o remd_001_small_024.mdout.$REP -c remd_001_small_023.rst.$REP -r remd_001_small_024.rst.$REP -x remd_001_small_024.ncdf.$REP -inf remd_001_small_024.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_024.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_025.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_025.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_025.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_025.log -i remd_001_small_025.mdin.$REP -o remd_001_small_025.mdout.$REP -c remd_001_small_024.rst.$REP -r remd_001_small_025.rst.$REP -x remd_001_small_025.ncdf.$REP -inf remd_001_small_025.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_025.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_026.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_026.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_026.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_026.log -i remd_001_small_026.mdin.$REP -o remd_001_small_026.mdout.$REP -c remd_001_small_025.rst.$REP -r remd_001_small_026.rst.$REP -x remd_001_small_026.ncdf.$REP -inf remd_001_small_026.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_026.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_027.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_027.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_027.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_027.log -i remd_001_small_027.mdin.$REP -o remd_001_small_027.mdout.$REP -c remd_001_small_026.rst.$REP -r remd_001_small_027.rst.$REP -x remd_001_small_027.ncdf.$REP -inf remd_001_small_027.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_027.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_028.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_028.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_028.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_028.log -i remd_001_small_028.mdin.$REP -o remd_001_small_028.mdout.$REP -c remd_001_small_027.rst.$REP -r remd_001_small_028.rst.$REP -x remd_001_small_028.ncdf.$REP -inf remd_001_small_028.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_028.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_029.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_029.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_029.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_029.log -i remd_001_small_029.mdin.$REP -o remd_001_small_029.mdout.$REP -c remd_001_small_028.rst.$REP -r remd_001_small_029.rst.$REP -x remd_001_small_029.ncdf.$REP -inf remd_001_small_029.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_029.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_030.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_030.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_030.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_030.log -i remd_001_small_030.mdin.$REP -o remd_001_small_030.mdout.$REP -c remd_001_small_029.rst.$REP -r remd_001_small_030.rst.$REP -x remd_001_small_030.ncdf.$REP -inf remd_001_small_030.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_030.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_031.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_031.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_031.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_031.log -i remd_001_small_031.mdin.$REP -o remd_001_small_031.mdout.$REP -c remd_001_small_030.rst.$REP -r remd_001_small_031.rst.$REP -x remd_001_small_031.ncdf.$REP -inf remd_001_small_031.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_031.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_032.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_032.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_032.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_032.log -i remd_001_small_032.mdin.$REP -o remd_001_small_032.mdout.$REP -c remd_001_small_031.rst.$REP -r remd_001_small_032.rst.$REP -x remd_001_small_032.ncdf.$REP -inf remd_001_small_032.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_032.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_033.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_033.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_033.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_033.log -i remd_001_small_033.mdin.$REP -o remd_001_small_033.mdout.$REP -c remd_001_small_032.rst.$REP -r remd_001_small_033.rst.$REP -x remd_001_small_033.ncdf.$REP -inf remd_001_small_033.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_033.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_034.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_034.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_034.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_034.log -i remd_001_small_034.mdin.$REP -o remd_001_small_034.mdout.$REP -c remd_001_small_033.rst.$REP -r remd_001_small_034.rst.$REP -x remd_001_small_034.ncdf.$REP -inf remd_001_small_034.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_034.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_035.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_035.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_035.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_035.log -i remd_001_small_035.mdin.$REP -o remd_001_small_035.mdout.$REP -c remd_001_small_034.rst.$REP -r remd_001_small_035.rst.$REP -x remd_001_small_035.ncdf.$REP -inf remd_001_small_035.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_035.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_036.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_036.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_036.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_036.log -i remd_001_small_036.mdin.$REP -o remd_001_small_036.mdout.$REP -c remd_001_small_035.rst.$REP -r remd_001_small_036.rst.$REP -x remd_001_small_036.ncdf.$REP -inf remd_001_small_036.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_036.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_037.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_037.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_037.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_037.log -i remd_001_small_037.mdin.$REP -o remd_001_small_037.mdout.$REP -c remd_001_small_036.rst.$REP -r remd_001_small_037.rst.$REP -x remd_001_small_037.ncdf.$REP -inf remd_001_small_037.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_037.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_038.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_038.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_038.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_038.log -i remd_001_small_038.mdin.$REP -o remd_001_small_038.mdout.$REP -c remd_001_small_037.rst.$REP -r remd_001_small_038.rst.$REP -x remd_001_small_038.ncdf.$REP -inf remd_001_small_038.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_038.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_039.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_039.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_039.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_039.log -i remd_001_small_039.mdin.$REP -o remd_001_small_039.mdout.$REP -c remd_001_small_038.rst.$REP -r remd_001_small_039.rst.$REP -x remd_001_small_039.ncdf.$REP -inf remd_001_small_039.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_039.groupfile
  rm -f temp temp2

  echo "TEMPERATURE: $TEMP K ==> FILE: remd_001_small_040.mdin.$REP"
  sed "s/XXXXX/$TEMP/g" remd_001_small_040.mdin > temp
  sed "s/RANDOM_NUMBER/$igzito/g" temp > temp2
  sed "s/job_id/$1/g" temp2 > remd_001_small_040.mdin.$REP
  echo "-O -rem 1 -remlog remd_001_small_040.log -i remd_001_small_040.mdin.$REP -o remd_001_small_040.mdout.$REP -c remd_001_small_039.rst.$REP -r remd_001_small_040.rst.$REP -x remd_001_small_040.ncdf.$REP -inf remd_001_small_040.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_001_small_040.groupfile
  rm -f temp temp2
  ...
  echo "-O -rem 1 -remlog remd_002.log -i remd_002.mdin.$REP -o remd_002.mdout.$REP -c remd_001_small_040.rst.$REP -r remd_002.rst.$REP -x remd_002.ncdf.$REP -inf remd_002.mdinfo.$REP -p ../LEAP/$1.prmtop" >> remd_002.groupfile
  rm -f temp temp2
