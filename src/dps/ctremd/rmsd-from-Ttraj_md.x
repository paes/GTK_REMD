...
parm $2
reference $2 parm $2 [pdb-file]
rms remd_total.$ext.pdb ref [pdb-file] :$3-$4@CA,C,N :$3-$4@CA,C,N out rmsd-total_Ttraj_$3-$4.$ext.dat
EOF
...
parm $2
reference $2 parm $2 [pdb-file]
rms remd_total.$ext.pdb ref [pdb-file] :$3-$4@CA :$3-$4@CA out rmsd-total_Ttraj_$3-$4_CA.$ext.dat
EOF
done
