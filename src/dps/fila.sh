...
#mpirun -machinefile machinefile -np 84 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_001.groupfile
...
#mpirun -machinefile machinefile -np 56 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_003.groupfile
tail remd_001_small_003.mdout.001 > tail_001_small_003.001-from-lad

mpirun -machinefile machinefile -np 42 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_004.groupfile
tail remd_001_small_004.mdout.001 > tail_001_small_004.001-from-lad

mpirun -machinefile machinefile -np 56 $AMBERHOME/bin/pmemd.MPI -ng 14 -groupfile remd_001_small_005.groupfile
